...
## USAGE
Try: 
    python -c "from test_iphreeqc.test_ex3 import ex3; print(ex3(lib=\"${HOME}/local/lib/iphreeqc-3.7.3-15968/libiphreeqc.so\", database=\"${HOME}/local/share/doc/iphreeqc-3.7.3-15968/database/phreeqc.dat\"))"
...
def ex3_mod(lib="libiphreeqc.so", database="phreeqc.dat"):
    ...
    Notes:
    * See the iphreeqc-3.7.3-15968 html documentation on
